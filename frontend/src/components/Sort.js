...
const Sort = ({sort, setSort, handleSort}) => {
    //console.log(sort)
    return(
        <div md="7" className="ml-3 d-flex align-items-center justify-content-end"> 
            ...
            <Form.Control as="select" value={sort} className="ml-3 mb-2" style={{ width: '20%', fontSize: "18px", borderRadius: "20px" }} onChange={e => handleSort(e.target.value)}>
